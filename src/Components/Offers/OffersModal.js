  ...
  return (
    <div>
      <div className={styles.headerDiv}>
        <Typography className={styles.header}>No Cost EMI</Typography>
        <Button
      ...
      <div className={styles.body}>
        <Typography className={styles.text1}>Special Offers</Typography>
        ...
        <Typography className={styles.btn} onClick={() => showFAQ(!FAQ)}>
          <BiChevronDown
        ...
        <Typography className={styles.btn} onClick={() => showTerms(!terms)}>
          <BiChevronDown
            className={styles.downIcon}
        ...
        {terms && (
          <div className={styles.termsDiv}>
            ...
            <Typography className={styles.termsBody}>
            ...
            <ul className={styles.ulTerms}>
              <li className={`${styles.termsBody} ${styles.listItem}`}>
            ...
            <Typography className={`${styles.termsBody} ${styles.listItem}`}>
  ...
  return (
    <div>
      {backShow ? (
        <div className={styles.headerDiv}>
          <Typography
            className={`${styles.header} ${styles.backButton}`}
            onClick={backClicked}
          >
            <BiChevronLeft className={styles.leftIcon} />
            Back
          </Typography>
          <Button
            className={styles.close}
        ...
        <div className={styles.headerDiv}>
          <Typography className={styles.header}>Bank Offers</Typography>
          <Button
            className={styles.close}
            onClick={() => {
              props.toggleDrawer(false);
      ...
      {backShow && offer1 && (
        <div className={styles.body}>
          <Typography className={styles.headerOffer}>Offer 1</Typography>
          <Typography className={styles.descOffer}>
            5% Instant Discount up to INR 250 on HSBC Cashback Card Credit Card
            Transactions. Minimum purchase value INR 1000
          </Typography>
          <Typography className={styles.promotionTermsOffer}>
            Promotion Terms
          </Typography>
          <center>
            <Typography className={styles.termsInnerHeading}>
            ...
            <li>
              <div>
                ...
                <ol>
                  ...
                  <li className={styles.termsBody}>Infant Nutrition</li>
                  <li className={styles.termsBody}>
                  ...
                  <li className={styles.termsBody}>Amazon Pay balance</li>
                  <li className={styles.termsBody}>
                    Select Smart/Mobile phones (see product page for offer
                    eligibility)
                  </li>
                  <li className={styles.termsBody}>Gold and Silver coins.</li>
                </ol>
              </div>
            </li>
          </ol>
          ...
          <br />
          <Divider className={styles.divider} />
          <Typography className={styles.availOffer}>
            How to avail offer
          </Typography>
          <ul className={styles.ulTerms}>
            <li className={styles.offerDesc}>
      ...
      {backShow && offer2 && (
        <div className={styles.body}>
          <Typography className={styles.headerOffer}>Offer 2</Typography>
          <Typography className={styles.descOffer}>
          ...
          <ol className={styles.ol}>
            <li>
              <Typography className={styles.termsBody}>
                ...
                website{" "}
                <a href="www.amazon.in" className={styles.amazonLink}>
                  www.amazon.in
                </a>{" "}
      ...
      {!backShow && (
        <div className={styles.body}>
          <Typography className={styles.offerTitle}>Offer 1</Typography>
          <Typography className={styles.offerDesc}>
            5% Instant Discount up to INR 250 on HSBC Cashback Card Credit Card
            Transactions. Minimum purchase value INR 1000
          </Typography>
          ...
          >
            See details
            <BiChevronRight className={styles.rightIcon} />
          </Typography>
          <Divider className={styles.divider} />
          <Typography className={styles.offerTitle}>Offer 2</Typography>
          <Typography className={styles.offerDesc}>
            10% Instant Discount up to INR 500 on Bank of Baroda Credit Card
            Transactions. Minimum purchase value INR 2000
          </Typography>
...
export const PartnerOffersModal = (props) => {
  return (
    <div>
      <div className={styles.headerDiv}>
        <Typography className={styles.header}>Partner Offers</Typography>
        <Button
          className={styles.close}
          onClick={() => {
            props.toggleDrawer(false);
      ...
      <div className={styles.body}>
        <Typography className={styles.partnerHeading}>
        ...
        <div className={styles.promotionTermsDiv}>
          <Typography className={styles.promotionTerms}>
            Promotion Terms
          </Typography>
          <Typography className={styles.termsInnerHeading}>
          ...
          <ol className={styles.ol}>
            ...
            <Typography className={styles.termsInnerHeading}>Note:</Typography>

            <Typography
              className={`${styles.termsBody} ${styles.noteMargin}`}
            >
            ...
            <li>
              <Typography
                className={`${styles.termsBody} ${styles.listItem}`}
              >
